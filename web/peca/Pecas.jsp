...
<html>
    ...
    <body class="bg">
        <% PecaDAO pdao = new PecaDAO();
            List<Peca> peca = pdao.listarPecas();
        %>
                ...
                <div class="panel panel-default" >
                    <div class="panel-heading">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <button type="button" class="btn btn-info" style="width: 100%;" onClick="location.href = 'CadastroPeca.jsp'">
                                    <span class="glyphicon glyphicon-plus"></span>Nova Peça
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tbl-content">
                        <table id="lista" class="table table lista">
                            <tbody class="seleciona">
                                ...
                                %>
                                <tr>
                                    <td class="col-md-1"><%= p.getPecid()%></td>
                                    <td class="col-md-1"><%= p.getPecdesc()%></td>
                                    <td class="col-md-1"><%= p.getPecvalor()%></td>
                                    <td class="col-md-1"><button type="button" class="btn btn-warning" onClick="location.href = 'AlteraPeca.jsp?codigo=<%=p.getPecid()%>'"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button></td>
                                </tr>
                                <%
                                    }
                                %>  
