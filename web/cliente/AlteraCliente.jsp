...
<html>
    ...
    <body class="bg">
        <% ClienteDAO cdao = new ClienteDAO();
            Cliente c = cdao.consulta(Integer.parseInt(request.getParameter("codigo")));
            c.setCliid(Integer.parseInt(request.getParameter("codigo")));
        %>
                    ...
                    <form name="frm" id="frm" class="col-md-12" action="../ControllerCliente" method="post">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <input type="text" class="form-control" id="txtid" name="txtid" readonly="readonly" value="<%= c.getCliid()%>" required>
                            </div>
                            <div class="form-group">
                                <label for="usr">Nome:<span class="required">*</span></label>
                                <br>
                                <input type="text" class="form-control" id="txtnome" name="txtnome" value="<%= c.getClinome()%>" required>
                            </div>
                            <div class="form-group">
                                <label for="">CPF:<span class="required">*</span></label>
                                <input type="text" class="form-control" id="txtcpf" name="txtcpf" minlength="14" maxlength="14" onblur="vcpf(this.value)" onkeypress="cpf()" value="<%= c.getClicpf()%>" required>
                            </div>
                            <div class="form-group">
                                <label for="">Telefone:<span class="required">*</span></label>
                                <input type="text" class="form-control" id="txtfone" name="txtfone" minlength="14" maxlength="14" onblur="vfone(this.value)" onkeypress="fone()" value="<%= c.getClifone()%>" required>
                            </div>
                            <div class="form-group">
                                <label for="">Email:<span class="required">*</span></label>
                                <input type="text" class="form-control" id="txtemail" name="txtemail" maxlength="40"  value="<%= c.getCliemail()%>" required>
                            </div>  
                        </fieldset>
