                    ...
                    <form name="frm" id="frm" class="col-md-12" action="../ControllerServico" method="post">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <input type="text" class="form-control" id="txtdesc" name="txtdesc" placeholder="Limpeza de Disco" required>
                            </div>
                            <div class="form-group">
                                <label for="">Valor:<span class="required">*</span></label>
                                <input type="text" class="form-control" id="txtvalor" name="txtvalor" maxlength="8" placeholder="80,00" required>
                            </div>
