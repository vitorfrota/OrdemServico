...
<html>
    ...
    <body class="bg">
        <% PecaDAO pdao = new PecaDAO();
            Peca p = pdao.consulta(Integer.parseInt(request.getParameter("codigo")));
            p.setPecid(Integer.parseInt(request.getParameter("codigo")));
        %> 
                    ...
                    <form name="frm" id="frm" class="col-md-12" action="../ControllerPeca" method="post">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <input type="text" class="form-control" id="txtid" name="txtid" readonly="readonly" value="<%= p.getPecid()%>" required>
                            </div>
                            <div class="form-group">
                                <label for="usr">Descrição:<span class="required">*</span></label>
                                <br>
                                <input type="text" class="form-control" id="txtdesc" name="txtdesc" value="<%= p.getPecdesc()%>" required>
                            </div>
                            <div class="form-group">
                                <label for="">Valor:<span class="required">*</span></label>
                                <input type="text" class="form-control" id="txtvalor" name="txtvalor" value="<%= p.getPecvalor()%>" required>
                            </div>
